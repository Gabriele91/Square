...
@echo on
REM clone git repo
git clone https://github.com/KhronosGroup/SPIRV-Cross.git spriv_cross_tmp_win32
@echo off
REM path of source
@set SOURCE_DIR=%TOP%spriv_cross_tmp_win32\
...
REM copy
@move /y "%SOURCE_DIR%Release\*.lib" "%TOP%dependencies\Win32\lib"
@move /y "%SOURCE_DIR%include\spirv_cross\*.h" "%TOP%dependencies\Win32\include\spirv_cross\"
@move /y "%SOURCE_DIR%include\spirv_cross\*.hpp" "%TOP%dependencies\Win32\include\spirv_cross\"
REM delete
@del /s /q  "%SOURCE_DIR%*"
