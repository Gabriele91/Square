...
namespace Layout
{
    SQUARE_REGISTERED_VERTEX(Vertex2D)
    SQUARE_REGISTERED_VERTEX(Vertex2DUV)
    SQUARE_REGISTERED_VERTEX(Vertex3D)
    SQUARE_REGISTERED_VERTEX(Vertex3DUV)
    SQUARE_REGISTERED_VERTEX(Vertex3DNormalUV)
    SQUARE_REGISTERED_VERTEX(Vertex3DNormalUVTangetBinomial)
